...
N=30        #Number of component chains
L=3000.     #Total length of assembly

#Power-law distribution for persistence lengths
slope=0.86        #Slope of stiffness-force graph
α= slope -2.     #Power law P(L_p)~L_p^(α)
minp, maxp=kT/100000,kT/9.

"""
Show individual and total curves for one assembly
"""
persistence_lengths=power_law_samples(α,N,minp,maxp)
...
display(current())
png("Plots/power_law_individual_responses")
...
for i in 1:n_samples
    ...
    sample_ps=power_law_samples(α,N,minp,maxp)
...
png("Plots/power_law_compare_data_sim")
